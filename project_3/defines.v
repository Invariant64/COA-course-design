...
`define REG_WRITE_SRC_CP0 3'b110
`define REG_WRITE_SRC_BRIDGE 3'b111
...
`define NPC_SEL_NORMAL 3'b000
`define NPC_SEL_RELATIVE 3'b001
`define NPC_SEL_NRELATIVE 3'b010
`define NPC_SEL_REG 3'b011
`define NPC_SEL_EPC 3'b100
`define NPC_SEL_INTERRUPT 3'b101

`define MEM_OP_WORD 1'b0
`define MEM_OP_BYTE 1'b1

`define CP0_REG_SEL_SR 5'b01100
`define CP0_REG_SEL_CAUSE 5'b01101
`define CP0_REG_SEL_EPC 5'b01110
`define CP0_REG_SEL_PRID 5'b01111
